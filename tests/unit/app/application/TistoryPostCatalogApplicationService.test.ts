...
describe("TistoryPostCatalogApplicationService", () => {
  it("keeps cache separated by Workspace/account and refresh bypasses it", async () => {
    ...
    const readPosts = vi.fn().mockResolvedValue({ posts: [{ platform: "tistory", externalPostId: "1", title: "공개 글", publishedUrl: "https://blog.tistory.com/entry/one", keywords: [], status: "public", retrievedAt: "2026-07-14T00:00:00.000Z" }], state: "success", retrievedAt: "2026-07-14T00:00:00.000Z", pagesRead: 1 });
